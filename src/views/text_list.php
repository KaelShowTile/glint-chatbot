    ...
    <div class="space-y-4">
        <?php foreach ($items ?? [] as $item): ?>
            <div class="border rounded p-4">
                <form action="/admin/text" method="POST" class="mb-2">
                    ...
                    <div class="flex justify-end space-x-2">
                        ...
                        <a href="/admin/text/delete/<?php echo $item['id']; ?>" class="bg-red-600 hover:bg-red-700 text-white px-4 py-1 rounded text-sm" onclick="return confirm('Are you sure you want to delete this?');">Delete</a>
                    </div>
                </form>
